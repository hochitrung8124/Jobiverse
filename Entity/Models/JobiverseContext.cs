...
public partial class JobiverseContext : DbContext
{
    ...
    public virtual DbSet<ProjectInvite> ProjectInvites { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Project>(entity =>
        {
            ...
            entity.HasOne(d => d.Discipline).WithMany(p => p.Projects)
        ...
        modelBuilder.Entity<ProjectInvite>(entity =>
        {
            ...
            entity.HasOne(d => d.Project).WithMany(p => p.ProjectInvites)
                .HasForeignKey(d => d.ProjectId)
                .HasConstraintName("ProjectInvites_ibfk_1");

            entity.HasOne(d => d.Student).WithMany(p => p.ProjectInvites)
                .HasForeignKey(d => d.StudentId)
                .HasConstraintName("ProjectInvites_ibfk_2");
        });
        ...
        modelBuilder.Entity<Student>(entity =>
        {
            ...
            entity.HasOne(d => d.Discipline).WithMany(p => p.Students)
                .HasForeignKey(d => d.DisciplineId)
                .OnDelete(DeleteBehavior.Cascade)
        ...
        modelBuilder.Entity<StudentApply>(entity =>
        {
            ...
            entity.Property(e => e.StudentApplyId).HasColumnName("StudentApplyID");
